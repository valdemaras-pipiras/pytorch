...
module_tests = [
    ...
    dict(
        module_name='RReLU',
        input_size=(1, 2, 2),
        cpp_input_args=['torch::randn({1, 2, 2})'],
        test_cuda=False,
    ),
    dict(
        module_name='RReLU',
        ...
        input_size=(4, 4, 5),
        cpp_input_args=['torch::randn({4, 4, 5})'],
        desc='with_up_down',
        test_cuda=False,
    ),
    dict(
    ...
    dict(
        ...
        input_size=(10, 20),
        cpp_input_args=['torch::randn({10, 20})'],
        reference_fn=lambda i, *_: torch.exp(i).div(torch.exp(i).sum(1, True).expand(10, 20)),
    ),
    dict(
        module_name='Softmax2d',
        input_size=(1, 3, 10, 20),
        cpp_input_args=['torch::randn({1, 3, 10, 20})'],
    ...
    dict(
        ...
        input_size=(4, 3, 2, 4),
        cpp_input_args=['torch::randn({4, 3, 2, 4})'],
    ),
    dict(
    ...
    dict(
        ...
        input_size=(2, 3, 6, 6),
        cpp_input_args=['torch::randn({2, 3, 6, 6})'],
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({2, 3, 4, 5, 6})'],
        reference_fn=lambda i, p, _: torch.clamp(i, min=0) + torch.clamp(i, max=0) * p[0][0],
        desc='3d',
    ),
    dict(
    ...
    dict(
        ...
        cpp_constructor_args='torch::nn::SoftminOptions(1)',
        input_size=(2, 3, 5, 10),
        cpp_input_args=['torch::randn({2, 3, 5, 10})'],
        desc='multidim',
    ),
    dict(
...
def poissonnllloss_no_reduce_test():
    ...
    return dict(
        ...
        cpp_input_args=['torch::rand({10, 10})'],
...
def kldivloss_no_reduce_test():
    ...
    return dict(
        ...
        cpp_input_args=['torch::rand({10, 10}).log()'],
...
def mseloss_no_reduce_test():
    ...
    return dict(
        ...
        # yf225 TODO: figure out how to do this one, and the rest from here
        cpp_input_args=['torch::'],
...
def nllloss_no_reduce_test():
    ...
    return dict(
        ...
        cpp_input_args=['torch::rand(15, 10).log()'],
        reference_fn=lambda i, *_:
...
def softmarginloss_no_reduce_test():
    ...
    return dict(
        ...
        cpp_input_args=['torch::randn(5, 5)'],
        reference_fn=lambda i, *_:
...
def multimarginloss_p_no_reduce_test():
    ...
    return dict(
        ...
        cpp_input_args=['torch::randn(5, 10).clamp_(1e-2, 1 - 1e-2)'],
        reference_fn=lambda i, *_:
...
new_module_tests = [
    ...
    dict(
        ...
        input_size=(4, 5, 3),
        cpp_input_args=['torch::randn({4, 5, 3})'],
        cudnn=True,
        check_eval=True,
        desc='3d_input',
    ),
    ...
    dict(
        ...
        cpp_constructor_args='torch::nn::BatchNorm1dOptions(10).eps(1e-3).momentum(0.3).affine(true).track_running_stats(false)',
        input_size=(4, 10),
        cpp_input_args=['torch::randn({4, 10})'],
        cudnn=True,
        check_eval=True,
    ...
    dict(
        ...
        cpp_constructor_args='torch::nn::BatchNorm1dOptions(5).eps(1e-3).momentum(0.3).affine(false)',
        input_size=(0, 5, 9),
        cpp_input_args=['torch::randn({0, 5, 9})'],
        cudnn=True,
        check_eval=True,
        desc='zero_batch',
    ),
    ...
    dict(
        ...
        cpp_constructor_args='torch::nn::BatchNorm2dOptions(3).eps(1e-3).momentum(0.8).affine(true).track_running_stats(false)',
        input_size=(2, 3, 6, 6),
        cpp_input_args=['torch::randn({2, 3, 6, 6})'],
        cudnn=True,
        check_eval=True,
    ...
    dict(
        ...
        input_size=(0, 5, 2, 2),
        cpp_input_args=['torch::randn({0, 5, 2, 2})'],
        cudnn=True,
        check_eval=True,
        desc='zero_batch',
    ),
    dict(
        ...
        cpp_input_args=['torch::randn({2, 3, 4, 4, 4})'],
        cudnn=True,
        check_eval=True,
    ),
    dict(
    ...
    dict(
        ...
        cpp_constructor_args='torch::nn::BatchNorm3dOptions(3).eps(1e-3).momentum(0.7).affine(true).track_running_stats(false)',
        input_size=(2, 3, 4, 4, 4),
        cpp_input_args=['torch::randn({2, 3, 4, 4, 4})'],
        cudnn=True,
        check_eval=True,
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({0, 5, 2, 2, 2})'],
        cudnn=True,
        check_eval=True,
        desc='zero_batch',
    ),
    dict(
        ...
        input_size=(4, 3, 15),
        cpp_input_args=['torch::randn({4, 3, 15})'],
        cudnn=True,
        check_eval=True,
    ),
    dict(
        ...
        cpp_constructor_args='torch::nn::InstanceNorm1dOptions(3).eps(1e-3).momentum(0.3).affine(false).track_running_stats(true)',
        input_size=(4, 3, 15),
        cpp_input_args=['torch::randn({4, 3, 15})'],
        cudnn=True,
        check_eval=True,
    ...
    dict(
        module_name='InstanceNorm2d',
        constructor_args=(3, 1e-3, 0.3, False, True),
        cpp_constructor_args='torch::nn::InstanceNorm2dOptions(3).eps(1e-3).momentum(0.3).affine(false).track_running_stats(true)',
        input_size=(2, 3, 6, 6),
        cpp_input_args=['torch::randn({2, 3, 6, 6})'],
        cudnn=True,
        check_eval=True,
    ...
    dict(
        module_name='InstanceNorm3d',
        constructor_args=(3, 1e-3, 0.3, False, True),
        cpp_constructor_args='torch::nn::InstanceNorm3dOptions(3).eps(1e-3).momentum(0.3).affine(false).track_running_stats(true)',
        input_size=(2, 3, 4, 4, 4),
        cpp_input_args=['torch::randn({2, 3, 4, 4, 4})'],
        cudnn=True,
        check_eval=True,
    ...
    dict(
        ...
        input_size=(4, 5, 5),
        cpp_input_args=['torch::randn({4, 5, 5})'],
        cudnn=True,
        check_eval=True,
    ...
    dict(
        ...
        input_size=(4, 2, 2, 5),
        cpp_input_args=['torch::randn({4, 2, 2, 5})'],
        cudnn=True,
        check_eval=True,
    ...
    dict(
        ...
        cpp_constructor_args='torch::nn::LayerNormOptions({5}).eps(1e-3)',
        input_size=(0, 5),
        cpp_input_args=['torch::randn({0, 5})'],
        cudnn=True,
        check_eval=True,
    ...
    dict(
        ...
        input_size=(4, 6, 5),
        cpp_input_args=['torch::randn({4, 6, 5})'],
        cudnn=True,
        check_eval=True,
        desc='1d_affine',
    ),
    ...
    dict(
        ...
        cpp_constructor_args='torch::nn::GroupNormOptions(3, 6).eps(1e-3)',
        input_size=(4, 6, 2, 3),
        cpp_input_args=['torch::randn({4, 6, 2, 3})'],
        cudnn=True,
        check_eval=True,
        desc='2d_affine',
    ),
    dict(
        ...
        input_size=(4, 3, 2, 3),
        cpp_input_args=['torch::randn({4, 3, 2, 3})'],
        cudnn=True,
        check_eval=True,
    ...
    dict(
        ...
        input_size=(2, 4, 10),
        cpp_input_args=['torch::randn({2, 4, 10})'],
        cudnn=True,
    ),
    dict(
        module_name='Conv1d',
    ...
    dict(
        ...
        input_size=(1, 4, 1),
        cpp_input_args=['torch::randn({1, 4, 1})'],
        cudnn=True,
        desc='pad1size1',
    ),
    dict(
    ...
    dict(
        ...
        cpp_constructor_args='torch::nn::Conv1dOptions(4, 5, 3)',
        input_size=(0, 4, 10),
        cpp_input_args=['torch::randn({0, 4, 10})'],
        cudnn=True,
        desc='zero_batch',
        test_cuda=(not TEST_WITH_ROCM),
    ),
    ...
    dict(
        ...
        input_size=(2, 4, 6),
        cpp_input_args=['torch::randn({2, 4, 6})'],
        cudnn=True,
    ),
    dict(
        ...
        cudnn=True,
        input_size=(1, 3, 7),
        cpp_input_args=['torch::randn({1, 3, 7})'],
    ),
    dict(
        module_name='ConvTranspose1d',
        constructor_args=(3, 4, 3, 2, 1, 1, 1, False),
        cpp_constructor_args='torch::nn::ConvTranspose1dOptions(3, 4, 3).stride(2).padding(1).output_padding(1).groups(1).bias(false)',
        input_size=(1, 3, 6),
        cpp_input_args=['torch::randn({1, 3, 6})'],
        cudnn=True,
        desc='no_bias',
    ),
    dict(
        ...
        cpp_constructor_args='torch::nn::ConvTranspose1dOptions(3, 4, 3).stride(2).padding(1).output_padding(1).groups(1).bias(true).dilation(2)',
        input_size=(1, 3, 6),
        cpp_input_args=['torch::randn({1, 3, 6})'],
        cudnn=True,
        desc='dilated',
    ...
    dict(
        ...
        cpp_constructor_args='torch::nn::ConvTranspose1dOptions(4, 6, 3).stride(3).padding(1).output_padding(1).groups(2)',
        cudnn=True,
        input_size=(2, 4, 7),
        cpp_input_args=['torch::randn({2, 4, 7})'],
    ),
    dict(
        ...
        input_size=(2, 10, 4),
        cpp_input_args=['torch::randn({2, 10, 4})'],
    ),
    dict(
        module_name='MaxPool1d',
    ...
    dict(
        ...
        input_size=(2, 3, 7, 5),
        cpp_input_args=['torch::randn({2, 3, 7, 5})'],
        cudnn=True,
    ...
    dict(
        ...
        input_size=(2, 3, 8, 8),
        cpp_input_args=['torch::randn({2, 3, 8, 8})'],
        cudnn=True,
        desc='dilated',
        check_with_long_tensor=True,
    ),
    dict(
        ...
        cpp_constructor_args='torch::nn::Conv2dOptions(3, 4, {3, 2}).stride(1).padding(0).dilation(1).groups(1).bias(false)',
        input_size=(2, 3, 6, 5),
        cpp_input_args=['torch::randn({2, 3, 6, 5})'],
        cudnn=True,
        desc='no_bias',
        check_with_long_tensor=True,
    ),
    dict(
        ...
        cpp_constructor_args='torch::nn::Conv2dOptions(3, 4, {3, 2})',
        input_size=(0, 3, 7, 5),
        cpp_input_args=['torch::randn({0, 3, 7, 5})'],
        cudnn=True,
        desc='zero_batch',
        check_with_long_tensor=True,
        test_cuda=(not TEST_WITH_ROCM),
    ...
    dict(
        ...
        input_size=(2, 4, 6, 5),
        cpp_input_args=['torch::randn({2, 4, 6, 5})'],
        cudnn=True,
        check_with_long_tensor=True,
    ),
    dict(
    ...
    dict(
        ...
        cpp_constructor_args='torch::nn::ConvTranspose2dOptions(3, 4, 3).stride({3, 2}).padding(1).output_padding({1, 1})',
        cudnn=True,
        input_size=(1, 3, 7, 6),
        cpp_input_args=['torch::randn({1, 3, 7, 6})'],
        check_with_long_tensor=True,
    ...
    dict(
        ...
        cpp_constructor_args='torch::nn::ConvTranspose2dOptions(3, 4, 3).stride({2, 3}).padding(1).output_padding({1, 1}).groups(1).bias(false).dilation({2, 2})',
        input_size=(1, 3, 6, 7),
        cpp_input_args=['torch::randn({1, 3, 6, 7})'],
        cudnn=True,
        desc='dilated',
        check_with_long_tensor=True,
    ),
    dict(
        ...
        cpp_constructor_args='torch::nn::ConvTranspose2dOptions(3, 4, 3).stride({2, 3}).padding(1).output_padding({1, 1}).groups(1).bias(false)',
        input_size=(1, 3, 6, 7),
        cpp_input_args=['torch::randn({1, 3, 6, 7})'],
        cudnn=True,
        desc='no_bias',
    ...
    dict(
        ...
        input_size=(1, 2, 4, 5),
        cpp_input_args=['torch::randn({1, 2, 4, 5})'],
        cudnn=True,
        check_with_long_tensor=True,
    ),
    dict(
        ...
        input_size=(2, 4, 6, 6),
        cpp_input_args=['torch::randn({2, 4, 6, 6})'],
    ),
    dict(
    ...
    dict(
        ...
        input_size=(2, 4, 5, 5),
        cpp_input_args=['torch::randn({2, 4, 5, 5})'],
    ),
    dict(
        ...
        input_size=(1, 3, 7, 7),
        cpp_input_args=['torch::randn({1, 3, 7, 7})'],
    ...
    dict(
        ...
        input_size=(2, 3, 6),
        cpp_input_args=['torch::randn({2, 3, 6})'],
    ),
    dict(
        module_name='AvgPool1d',
    ...
    dict(
        ...
        cpp_input_args=['torch::rand({1, 3, 7, 7})'],
        desc='norm',
    ),
    dict(
        ...
        cpp_input_args=['torch::rand({1, 3, 7})'],
        desc='norm',
    ),
    dict(
        module_name='LPPool1d',
    ...
    dict(
        ...
        input_size=(1, 5, 7),
        cpp_input_args=['torch::randn({1, 5, 7})'],
        desc='1d',
    ),
    dict(
        module_name='LocalResponseNorm',
        ...
        input_size=(1, 5, 7, 7),
        cpp_input_args=['torch::randn({1, 5, 7, 7})'],
        desc='2d_uneven_pad',
    ),
    dict(
        module_name='LocalResponseNorm',
        ...
        cpp_input_args=['torch::randn({1, 5, 7, 7, 7})'],
    ...
    dict(
        ...
        input_size=(2, 3, 8),
        cpp_input_args=['torch::randn({2, 3, 8})'],
    ),
    dict(
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({2, 3, 3, 4, 5})'],
        cudnn=True,
        check_with_long_tensor=True,
    ),
    dict(
        ...
        cpp_constructor_args='torch::nn::Conv3dOptions(3, 4, {2, 3, 4}).stride(1).padding(0).dilation(1).groups(1).bias(false)',
        input_size=(2, 3, 3, 4, 5),
        cpp_input_args=['torch::randn({2, 3, 3, 4, 5})'],
        cudnn=True,
        desc='no_bias',
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({2, 3, 5, 5, 5})'],
        cudnn=True,
        desc='stride',
        check_with_long_tensor=True,
    ),
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({0, 3, 3, 4, 5})'],
        cudnn=True,
        check_with_long_tensor=True,
        desc='zero_batch',
        test_cuda=(not TEST_WITH_ROCM),
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({2, 4, 4, 5, 4})'],
        cudnn=True,
        check_with_long_tensor=True,
    ),
    dict(
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({1, 2, 4, 5, 4})'],
    ),
    dict(
        module_name='ConvTranspose3d',
        constructor_args=(2, 3, (2, 3, 2), 1, 0, 0, 1, True, (2, 2, 2)),
        cpp_constructor_args='torch::nn::ConvTranspose3dOptions(2, 3, {2, 3, 2}).stride(1).padding(0).output_padding(0).groups(1).bias(true).dilation({2, 2, 2})',
        cudnn=True,
        input_size=(1, 2, 4, 5, 4),
        cpp_input_args=['torch::randn({1, 2, 4, 5, 4})'],
        desc='dilated',
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({2, 3, 2, 4, 8})'],
    ...
    dict(
        constructor=wrap_functional(F.interpolate, size=12, scale_factor=None, mode='nearest'),
        input_size=(0, 2, 4),
        cpp_input_args=['torch::randn({0, 2, 4})'],
    ...
    dict(
        constructor=wrap_functional(F.interpolate, size=(12, ), scale_factor=None, mode='nearest'),
        input_size=(1, 2, 3),
        cpp_input_args=['torch::randn({1, 2, 3})'],
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({1, 128, 1, 1})'],
    ...
    dict(
        constructor=wrap_functional(F.interpolate, size=12, scale_factor=None, mode='nearest'),
        input_size=(1, 2, 4, 4),
        cpp_input_args=['torch::randn({1, 2, 4, 4})'],
    ...
    dict(
        ...
        input_size=(1, 2, 3, 4),
        cpp_input_args=['torch::randn({1, 2, 3, 4})'],
    ...
    dict(
        constructor=wrap_functional(F.interpolate, size=12, scale_factor=None, mode='nearest'),
        input_size=(0, 2, 4, 4),
        cpp_input_args=['torch::randn({0, 2, 4, 4})'],
    ...
    dict(
        ...
        input_size=(1, 2, 2, 3),
        cpp_input_args=['torch::randn({1, 2, 2, 3})'],
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({1, 2, 4, 4, 4})'],
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({0, 2, 4, 4, 4})'],
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({1, 2, 3, 4, 4})'],
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({1, 2, 2, 3, 3})'],
    ...
    dict(
        ...
        cpp_input_args=['_rand_tensor_non_equal({1, 3, 5})'],
    ),
    dict(
        ...
        cpp_input_args=['_rand_tensor_non_equal({1, 3, 5, 6})'],
        desc='single',
    ),
    dict(
        module_name='AdaptiveMaxPool2d',
    ...
    dict(
        ...
        cpp_input_args=['_rand_tensor_non_equal({2, 3, 5, 6, 7})'],
        desc='single',
    ),
    dict(
        module_name='AdaptiveMaxPool3d',
    ...
    dict(
        ...
        cpp_input_args=['_rand_tensor_non_equal({2, 3, 12, 9, 3})'],
    ...
    dict(
        ...
        cpp_input_args=['_rand_tensor_non_equal({2, 3, 6, 4, 10})'],
    ...
    dict(
        ...
        cpp_input_args=['torch::rand({1, 3, 5})'],
    ),
    dict(
        module_name='AdaptiveAvgPool1d',
        constructor_args=(1,),
    ...
    dict(
        ...
        cpp_input_args=['torch::rand({1, 3, 5, 6})'],
        desc='single',
    ),
    dict(
        module_name='AdaptiveAvgPool2d',
    ...
    dict(
        module_name='GLU',
        input_size=(5, 6),
        cpp_input_args=['torch::randn({5, 6})'],
    ),
    dict(
        module_name='GLU',
        constructor_args=(1,),
        ...
        input_size=(5, 6, 7),
        cpp_input_args=['torch::randn({5, 6, 7})'],
        desc='dim',
    ),
    dict(
        module_name='GELU',
    ...
    dict(
        ...
        input_size=(2, 128),
        cpp_input_args=['torch::randn({2, 128})'],
    ...
    dict(
        ...
        input_size=(2, 4, 3, 3),
        cpp_input_args=['torch::randn({2, 4, 3, 3})'],
        check_gradgrad=False,
        test_cuda=True,
    ),
    dict(
        ...
        input_size=(2, 16, 4),
        cpp_input_args=['torch::randn({2, 16, 4})'],
        check_gradgrad=False,
        test_cuda=True,
    ),
    dict(
    ...
    dict(
        ...
        cpp_input_args=['torch.arange(6, out=torch.DoubleTensor()).reshape([1, 2, 3])'],
    ...
    dict(
        ...
        cpp_input_args=['torch.arange(6, out=torch.DoubleTensor()).reshape([1, 1, 2, 3])'],
    ...
    dict(
        ...
        cpp_input_args=['torch.arange(9, out=torch.DoubleTensor()).reshape([1, 1, 3, 3])'],
    ...
    dict(
        ...
        cpp_input_args=['torch.arange(12, out=torch.DoubleTensor()).reshape([1, 1, 2, 2, 3])'],
...
criterion_tests = [
    ...
    dict(
        ...
        cpp_input_args=['torch::rand({15, 10}).clamp_(1e-2, 1 - 1e-2)'],
        target_fn=lambda: torch.randn(15, 10).gt(0).to(torch.get_default_dtype()),  # yf225 TODO: comment: the old code only works because the default dtype in the test suite is double!
    ...
    dict(
        ...
        input_size=(15, 10),
        cpp_input_args=['torch::randn({15, 10})'],
        target_fn=lambda: torch.Tensor(15).uniform_().mul(10).floor().long(),
        cpp_target_args=['torch::empty({15}).uniform_().mul(10).floor().to(torch::kLong)'],
    ),
    dict(
    ...
    dict(
        ...
        cpp_input_args=['torch::rand({5, 10}).clamp_(1e-2, 1 - 1e-2)'],
        target_fn=lambda: torch.rand(5).mul(8).floor().long(),
        cpp_target_args=['torch::rand(5).mul(8).floor().to(torch::kLong)'],
        reference_fn=lambda i, t, m:
    ...
    dict(
        ...
        cpp_input_args=['torch::rand({15, 10})', 'torch::rand({15, 10})'],
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({50}).mul(10)', 'torch::randn({50}).mul(10)'],
...
new_criterion_tests = [
    ...
    dict(
        ...
        cpp_input_args=['torch::rand({}).clamp_(1e-2, 1 - 1e-2)'],
    ...
    dict(
        module_name='NLLLoss',
        input_size=(2, 3, 5, 5),
        cpp_input_args=['torch::randn({2, 3, 5, 5})'],
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({2, 3, 5, 5, 2, 2})'],
    ...
    dict(
        module_name='NLLLoss',
        input_size=(2, 3, 5),
        cpp_input_args=['torch::randn({2, 3, 5})'],
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({2, 3, 4, 5}).abs_().add_(0.001)'],
        target_fn=lambda: torch.randn(2, 3, 4, 5).floor_().abs_(),
        cpp_target_args=['torch::randn({2, 3, 4, 5}).floor_().abs_()'],
    ...
    dict(
        ...
        cpp_input_args=['torch::ones({5, 68, 64, 64}, torch::kFloat).div(10)'],
